...
M.config = function()
  require("gitsigns").setup({
    on_attach = function(bufnr)
      ...
      map("gj", "<cmd>lua require 'gitsigns'.next_hunk({navigation_message = false})<cr>zz", "Next Hunk")
      map("gk", "<cmd>lua require 'gitsigns'.prev_hunk({navigation_message = false})<cr>zz", "Prev Hunk")
